...
> Special thanks to [Tolin Simpson](https://github.com/TolinSimpson) for this [automated build tool](https://github.com/TolinSimpson/neutralinojs-build-automation-template). It makes things a lot easier.
